...
const drop = () => {
  ...
  ['dropenter', 'dragleave', 'dragover', 'drop'].forEach(eventName => {
...
const modals = () => {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', () => {
      if (!btnPressed && window.scrollY + document.documentElement.clientHeight + 1 >= document.documentElement.scrollHeight) {
